...
const initialState = {
  ringBell: {
    uri: require('Imbibo/assets/audiosImbibo/not_1.mp3'),
    number: 1,
  },
};
  ...
  switch (action.type) {
    ...
    case actions.RINGBELL_2:
      return {
        ...state,
        ringBell: {
          uri: require('Imbibo/assets/audiosImbibo/not_2.mp3'),
          number: 2,
        },
      };
    case actions.RINGBELL_3:
      return {
        ...state,
        ringBell: {
          uri: require('Imbibo/assets/audiosImbibo/not_3.mp3'),
          number: 3,
        },
      };
    case actions.RINGBELL_4:
      return {
        ...state,
        ringBell: {
          uri: require('Imbibo/assets/audiosImbibo/not_4.mp3'),
          number: 4,
        },
      };
