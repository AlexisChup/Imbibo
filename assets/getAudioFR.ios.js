...
export const fewActionDis = [
	{
		actionAudio: { uri: 'asset:/21_fr.m4a' },
	...
	// {
	//     actionAudio  : require('./audios/FR/few/distribute/.m4a'),
	//     actionName   : "Distribue 2 gorgées"
	// },
	// {
	//     actionAudio  : require('./audios/FR/few/distribute/.m4a'),
...
export const fewActionTak = [
	...
	// {
	//     actionAudio  : require('./audios/FR/few/take/.m4a'),
	//     actionName   : "Prends 2 gorgées"
	// },
	// {
	//     actionAudio  : require('./audios/FR/few/take/.m4a'),
	//     actionName   : "Prends 2 gorgées"
...
export const mediumActionDis = [
	...
	// {
	//     actionAudio  : require('./audios/FR/medium/distribute/.m4a'),
	//     actionName   : "Distribue 4 gorgées"
	// },
	// {
	//     actionAudio  : require('./audios/FR/medium/distribute/.m4a'),
...
export const mediumActionTak = [
	...
	// {
	//     actionAudio  : require('./audios/FR/medium/take/.m4a'),
	//     actionName   : "Prends 4 gorgées"
	// },
	// {
	//     actionAudio  : require('./audios/FR/medium/take/.m4a'),
	//     actionName   : "Prends 4 gorgées"
...
export const manyActionDis = [
	...
	// {
	//     actionAudio  : require('./audios/FR/many/distribute/.m4a'),
	//     actionName   : "Distribue 6 gorgées"
	// },
	// {
	//     actionAudio  : require('./audios/FR/many/distribute/.m4a'),
...
export const calActionDis = [
	...
	// {
	//     actionAudio  : require('./audios/FR/cal/distribute/.m4a'),
	//     actionName   : "Tu peux donner 1 cul sec"
	// },
];
export const calActionTak = [
	...
	// {
	//     actionAudio  : require('./audios/FR/cal/take/.m4a'),
	//     actionName   : "Tu peux prendre 1 cul sec"
	// },
];
export const shotActionDis = [
	...
	// {
	//     actionAudio  : require('./audios/FR/shot/distribute/.m4a'),
	//     actionName   : "Tu peux donner 1 shot"
	// },
];
export const shotActionTak = [
	...
	// {
	//     actionAudio  : require('./audios/FR/shot/take/.m4a'),
	//     actionName   : "Tu peux prendre 1 shot"
	// },
];
export const ebyAction = [
	...
	//     actionName   : "Tout le monde Prends 6 gorgées"
	// },
	// {
	//     actionAudio  : require('./audios/FR/all/.m4a'),
	//     actionName   : "Tout le monde Prends 6 gorgées"
