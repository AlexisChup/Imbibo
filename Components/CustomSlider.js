			...
			<View style={styles.container}>
				<View style={styles.containerSlider}>
					<MultiSlider
						...
						customMarkerLeft={(e) => {
							return (
								<MarkerSlider value={e.currentValue} premium={premium} index={1} pressed={e.pressed} />
							);
						}}
						customMarkerRight={(e) => {
							return (
								<MarkerSlider value={e.currentValue} premium={premium} index={2} pressed={e.pressed} />
							);
						}}
