...
class PremiumPopUp extends React.Component {
  ...
  async _isPaymentPossible() {
    ...
    try {
      ...
      const productToBuyArray = await Purchases.getProducts(
        itemIAP,
        PURCHASE_TYPE.INAPP,
      );
      ...
      <View style={{justifyContent: 'center', alignItems: 'center'}}>
        <AnimatedOnPress toggleOnPress={this.toggleModal}>
          <Image
            ...
            source={require('../assets/button-images/button-premium.png')}
          />
        </AnimatedOnPress>
        {this._awesomeAlert()}
        ...
        >
          <View style={styles.premiumPopUp}>
              ...
              <View>
                ...
                <View>
                  <View style={styles.popUpDescriptionContainer}>
                    <Text style={styles.popUpDescriptionBulletPoint}>
                      {'\u2B24'}
                    </Text>
            ...
            <TouchableWithoutFeedback
              onPress={async () => this._purchasePremium()}>
              <Animated.View
                style={[styles.buttonPremiumContainer, animatedStyleButton]}>
                <Text
                  style={[
                    {
                      textAlign: 'center',
